...
# Recompute the operational, mean-aligned sign score used in the revised paper.
# The frozen extbench archive stores the earlier modal-vote score; the rebuilt
# member-gradient archive makes the three modal/mean mismatches auditable.
member_candidates = [
    os.path.join(DIR, 'external_members_tmm_easy.npz'),
    os.path.join(DIR, '..', 'external_members_tmm_easy.npz'),
    os.path.join(DIR, '..', '..', 'reproducibility_update',
