...
- `tie_sensitivity.py`: prevalence and frontier sensitivity under 1,000
  random resolutions of equal-score components.
- `subensemble_sensitivity.py`: score and allocation sensitivity to the number
