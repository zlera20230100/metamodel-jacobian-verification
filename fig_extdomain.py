# -*- coding: utf-8 -*-
"""External-domain ROC comparison using the revised mean-aligned sign score."""
import os
...
def find_member_archive(filename):
    candidates = [
        ...
        os.path.join(DIR, '..', filename),
        os.path.join(DIR, '..', '..', 'reproducibility_update', filename),
    ]
...
# Query-clustered 95% CIs reported in the revised manuscript.
